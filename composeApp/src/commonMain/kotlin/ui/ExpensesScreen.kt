...
@Composable
fun ExpenseItem(expense: Expense, onClick: (expense: Expense) -> Unit) {
    val colors = getColorsTheme()

    Card(
        modifier = Modifier.fillMaxWidth().padding(2.dp).clickable { onClick(expense) },
        ...
        Row(
            ...
            Surface(
                ...
                Image(
                    ...
                    contentDescription = "${expense.category.name} icon",
